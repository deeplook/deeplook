...
| [svglib](https://github.com/deeplook/svglib) | Convert SVG files into PDF and bitmap formats via ReportLab |
| [time-machine-mcp-server](https://github.com/deeplook/time-machine-mcp-server) | MCP server to access Apple Time Machine backups |
